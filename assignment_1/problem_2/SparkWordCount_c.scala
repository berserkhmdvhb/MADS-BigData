...
object SparkWordCount_c {
  def main(args: Array[String]): Unit = {
    ...
    val stopwords = Source.fromFile(args(2)).getLines.toList // this should now be a list of the stopwords
    ...
    def is_stopWord(token: String): Boolean = {
      stopwords.find(t => t.equals(token)) match {
